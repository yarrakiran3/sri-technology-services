...
<hr className="my-6 border-gray-900 mx-6 sm:mx-6 dark:border-white lg:my-8" />
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 md:w-full">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href={"/"} className="flex items-center">
                  ...
                  <span className="self-center text-2xl text-blue-600 font-semibold whitespace-nowrap dark:text-white">Sri Innovation Services Inc.</span>
              </Link>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link href={"/"} className="hover:underline">Sri Innovation Services Inc. </Link>. All Rights Reserved.
          </span>
