...
<div className="text-center  m-auto  mt-12 md:text-3xl md:mt-36">
    ...
    <span className="text-blue-600">Sri Innovation Services Inc.</span> was founded with a vision to <span className="text-orange-600">transform the IT landscape </span> through innovation and dedication. 
...
<div className="text-center  m-auto mt-12   md:text-3xl md:mt-8">
    {/* Meet the faces behind Sri Innovation Services Inc., 
